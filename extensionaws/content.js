const API_URL =
  "https://kiuurc17j1.execute-api.us-east-1.amazonaws.com/default/WInfo1-similarities1DC6E674-qKUBw0bD9Opz";
...
function getButton(str, textDisplay) {
  ...
  ele.onclick = function () {
    ...
    if (textDisplay.style.display === "block") {
      ...
      httpPostAsync(API_URL, str, (response) => {
        // Parse the response
        ...
        for (let i = 0; i < answer.length; i++) {
          ...
          answersHTML[i].onclick = function (e) {
...
function httpPostAsync(theUrl, content, callback) {
